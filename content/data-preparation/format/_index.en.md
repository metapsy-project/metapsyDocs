...
Of course, it is also possible for RCTs included in a database to provide more than one row; for example because the study was a **multi-arm trial**. In a multi-arm trial with <span style="font-family: Times">a</span> arms,  there are <span style="font-family: Times">a!/(2!(a-2)!)</span> unique trial arm comparisons. 
