...
<img src="/uploads/metapsy-flow.png" width="100%" style="border-radius: 5px; margin-top: 20px; margin-bottom: 20px;">
...
* The [**{metapsyData} R package**](https://data.metapsy.org) allows to access all Metapsy databases directly in an R environment.
