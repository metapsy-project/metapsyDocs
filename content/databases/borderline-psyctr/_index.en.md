...
<div class="citation" id="citation-borderline-psyctr" style='background-color: var(--body-color); padding: 20px 20px 20px 20px; font-size: 80%; -webkit-filter: grayscale(100%); filter: grayscale(100%); position: relative;'>
<button class="citation-copy-btn" onclick="copyCitation('citation-borderline-psyctr', this)" title="Copy citation to clipboard" style="position: absolute; top: 10px; right: 10px;">
